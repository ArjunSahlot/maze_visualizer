...
file = "maze_visualizer-"
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/maze_visualizer/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/maze_visualizer/archive/master.zip", tmp)
    file += "master"
